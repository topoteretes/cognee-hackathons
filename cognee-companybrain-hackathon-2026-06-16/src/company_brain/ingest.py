...
from .cognee_client import connect, write, write_typed
...
class IngestReport:
    ...
    def total(self) -> int:
        return self.slack_docs + self.granola_docs
...
def main() -> None:
    ...
    log.info(
        "ingest done — slack=%d granola=%d failures=%d classified=%d seeded_people=%d",
        report.slack_docs,
        report.granola_docs,
        report.failures,
        report.classified,
