#!/usr/bin/env python3
"""Demo: Cloud cognee search with Qdrant Cloud + OpenAI."""
...
required = ["VECTOR_DB_URL", "VECTOR_DB_KEY"]
...
async def main():
    print("=" * 50)
    print("Cloud Demo: cognee + Qdrant Cloud")
    print("=" * 50)
    print()
    ...
    print(f"Qdrant:     {config.vector_db_url[:50]}...")
